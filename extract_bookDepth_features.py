...
def main():
    ...
    if old_files:
        # make best_date tz-aware to avoid compare errors
        best, best_date = None, pd.Timestamp.min.tz_localize("UTC")
        for f in old_files:
