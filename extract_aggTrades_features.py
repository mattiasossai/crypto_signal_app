...
Debug-Logging und korrekte Typen für timestamp.
"""
...
def main(input_dir, output_file, start_date, end_date, normalize=False):
    ...
    if not files:
        logging.warning("No CSVs found, exiting."); return
