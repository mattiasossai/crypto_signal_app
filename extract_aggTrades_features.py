...
Mit Debug-Logging, korrekten dtypes und fehlerfreier End-Timestamp-Berechnung.
"""
...
if __name__ == '__main__':
    ...
    parser.add_argument('--normalize',   action='store_true', help="Z-Score-Normalisierung aktivieren")
